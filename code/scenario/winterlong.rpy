...
label din_winterlong_story_bar:
    ...
    din_narrator "Огонёк когда-то был невероятным. Он излучал счастье и радость, чуть ли не единственный в этой потерянной череде лагерей."
    ...
    din_narrator "Такое случается с каждым. С разной периодичностью, но это ждёт всех."
    din_narrator "Сейчас только я и Ниточник, кажется, еще не «омолаживались». Мы помним всех остальных, но не друг друга."
