label din_ikarus_story:
    ...
    din_nit "Одному Пионеру, Ожидателю, как-то в голову стрельнула мысль: что будет, если обратиться к какой-то сверхсильной сущности, чтобы та вытащила его во Внешний мир?"
    din_teapot "Вроде помощи извне? Хитро."
    din_narrator "Я даже перестал крепить пару струн к ЛЭП, чтобы не упустить деталей истории."
    ...
    # FIXME: здесь заканчивается кусок текста, который нужно отредактировать
