label din_winterlong_story:
    ...
    din_narrator "Все друг за другом молча занимали места у очага. Новенькие нервно смотрели по сторонам, а мои сверстники расслабленно откидывались назад, закрывая глаза и наслаждаясь холодом ночи."
...
label din_winterlong_story_science:
    ...
    din_third "Лагерь — лучшее, что случилось с нами."
...
label din_winterlong_story_interlude:
    ...
    din_th "Тогда бы образовалась крохотная несовершенность на необъятном полотне, которая мозолила бы мне глаза своим существованием всю вечность."
    ...
    din_narrator "Пошла уже двадцать пятая сотня минут. {w}Кому-то пора просыпаться."
    stop music fadeout 2
    stop ambience fadeout 2
    scene bg black with Dissolve(2)
