...
label din_winterlong_story_science:
    ...
    din_teapot "Оно вряд ли находится выше пяти километров над землей, из чего можно сделать приблизительные рассчеты."
    ...
    din_teapot "Рассчеты я, разумеется, уже провёл. {w}В очень сухой теории источниками могут служить крохотные ядерные синтезы. {w}Молекулярные, можно сказать. {w}В теории, потому что я их не нашел."
