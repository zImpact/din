label din_winterlong_story:
    ...
    din_narrator "Все друг за другом молча занимали места у очага. Новенькие нервно смотрели по сторонам, а мои сверстники расслабленно откидывались назад, закрыя глаза и наслаждаясь холодом ночи."
...
label din_winterlong_story_science:
    ...
    din_teapot "Отвыкай от этого имени. Неделя Зимы заканчивается, скоро его поменяю. {w}Но что бы такое придумать..."
    ...
    din_narrator "Мне в руки попал обвязаный кругом красный галстук, теперь напоминающий бандану. {w}Судя по тому, что галстук Чайника был на своём стабильном месте, бандану он у кого-то отобрал."
